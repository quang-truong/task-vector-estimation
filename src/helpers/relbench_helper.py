'''
This file is a modified version of the original file from the RelBench repository. 
Allows for downloading and caching of datasets from the RelBench server.
'''
import os
...
from relbench.datasets import amazon, avito, event, f1, hm, stack, trial, hashes
...
def register_dataset(
    ...
    **kwargs,
    ...
    cache_dir = f"{os.path.join(DATA_DIR, 'relbench')}/{name}"
