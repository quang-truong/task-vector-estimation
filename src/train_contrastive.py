...
from src.helpers.contrastive_train_helper import train, test

from src.models.contrastive import Contrastive
...
def main(cfg, cfg_file, sweep_file, sweep_folder_name=None):
    ...
    for run in range(cfg.num_runs):
        ...
        print(f"Loaded Contrastive({', '.join([f'{k}={v}' for k, v in cfg.model.items()])})")
