...
from src.helpers.tve_mae_train_helper import train, test

from src.models.tve_mae import TVEMAE
...
def main(cfg, cfg_file, sweep_file, sweep_folder_name=None):
    ...
    for run in range(cfg.num_runs):
        ...
        print(f"Loaded TVEMAE({', '.join([f'{k}={v}' for k, v in cfg.model.items()])})")
